	...
	messages: [
		{
			role: "system",
			content:
				"You are a helpful assistant that can only respond with valid JSON and nothing else. You can not add commentary or any content before or after the json. Do not wrap any code block around the json. Your only response MUST be JSON.",
		},
	],
	modelOptions: {
		response_format: {
